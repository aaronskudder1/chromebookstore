...
export const Products: IProduct[] = [
      ...
      },
   {
      ...
      },
      {
        id: 10,
        description:
          "Lenovo N22 - 11.6in. HD Display, Intel Celeron N3050, 2GB RAM, 16GB eMMC Storage, Chrome OS, Black",
        name: "Lenovo N22",
        imageName: "LenovoN22.png",
        category: "Lenovo",
        price: 50.0,
        discount: 0,
        stock:2,
      },
       {
        id: 11,
        description:
          "HP 2101TU- 11.6in. HD Display, Intel Celeron N284050, 2GB RAM, 16GB eMMC Storage, Chrome OS, White",
        name: "HP2101TU",
        imageName: "HP2101TU.png",
        category: "HP",
        price: 40.0,
        discount: 0,
        stock:8,
